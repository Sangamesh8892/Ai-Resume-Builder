  ...
  const templates = [
    {
      ...
      name: "Classic",
      preview:
        "A traditional resume with clean sections and a professional layout.",
    },
    {
      id: "modern",
      name: "Modern",
      preview:
        "A sleek, contemporary design with sharp structure and bold accents.",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
      preview:
        "A minimal layout featuring a profile image for a clean, personal touch.",
    },
    {
      id: "minimal",
      name: "Minimal",
      preview:
        "A simple, distraction-free layout focused on clarity and readability.",
    },
  ];
